...
export default function SubscribeForm() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Crear referencia al documento participants en la colección waitlist
      const participantsDocRef = doc(db, "waitlist", "participants");

      // Actualizar el documento agregando el nuevo correo electrónico al array de correos
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">
            Join the members who have already signed up.
          </p>
        </div>
      </div>
    </>
